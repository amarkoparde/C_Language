/*
    Accept N numbers from user and one number, return first occurrence of that number */
/*
...
int FirstOccurrence(int Arr[], int iSize,int iNo)
{
    int iCnt = 0;
...
int main()
{
    ...
    iRet = FirstOccurrence(ptr,iValue,iNo);
